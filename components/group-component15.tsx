...
const GroupComponent15: NextPage<GroupComponent15Type> = ({
  ...
  return (
    <div
      className={`w-[393px] bg-oldlace-200 flex flex-col items-start justify-start pt-[15px] px-[75px] pb-20 box-border gap-[61px] min-w-[393px] max-w-full z-[1] text-left text-13xl text-black font-poppins mq800:min-w-full mq450:gap-[30px] mq450:pt-5 mq450:px-5 mq450:pb-[52px] mq450:box-border mq1350:flex-1 ${className}`}
    >
      ...
      <div className="self-stretch flex flex-col items-end justify-start gap-[42px] text-base">
        <div className="self-stretch flex flex-col items-start justify-start gap-[31px]">
          <div className="self-stretch flex flex-row items-start justify-between gap-5">
            ...
            <div className="relative text-darkgray inline-block min-w-[112px] z-[1]">
              Rs. 250,000.00
            </div>
          </div>
          <div className="self-stretch flex flex-row items-start justify-between gap-5">
