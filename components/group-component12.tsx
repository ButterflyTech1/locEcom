...
const GroupComponent12: NextPage<GroupComponent12Type> = ({
  ...
  return (
    <div
      className={`flex-1 bg-white flex flex-col items-start justify-start pt-[87px] pb-[86px] pl-[38px] pr-[37px] box-border gap-[34.8px] min-w-[395px] max-w-full z-[1] text-left text-5xl text-black font-poppins mq800:gap-[17px] mq800:pt-[57px] mq800:pb-14 mq800:box-border mq800:min-w-full mq450:pt-[37px] mq450:pb-9 mq450:box-border mq1350:flex-1 ${className}`}
    >
      ...
      <div className="self-stretch flex flex-row items-start justify-between gap-5 mq450:flex-wrap">
          ...
          <div className="self-stretch flex flex-row items-start justify-start py-0 pl-px pr-0 text-xs">
            <div className="flex-1 flex flex-row items-start justify-start gap-[10.5px]">
              <div className="flex-1 flex flex-col items-start justify-start gap-[22px] text-base">
                <div className="relative text-darkgray inline-block min-w-[108px] z-[1]">
                  Asgaard sofa
                </div>
        ...
        <div className="w-[178px] flex flex-col items-start justify-start gap-3.5">
          ...
          <div className="self-stretch flex flex-col items-start justify-start gap-[22px] text-base">
            <div className="self-stretch flex flex-row items-start justify-end py-0 px-1">
              <div className="relative font-light inline-block min-w-[109px] z-[1]">
                Rs. 250,000.00
              </div>
            </div>
      ...
      <div className="self-stretch flex flex-row items-start justify-center py-0 pl-[7px] pr-0">
        <Button
          className="h-16 w-[318px] z-[1] mq450:pl-5 mq450:pr-5 mq450:box-border"
          disableElevation
          variant="outlined"
          sx={{
            textTransform: "none",
